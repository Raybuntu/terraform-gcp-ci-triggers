...
variable "build_trigger_sa" {
  description = "Build Trigger service account object"
  type        = object({
    name  = string
    id = string
  })
...
variable "webapp_trigger_sa" {
  description = "Webapp Build Trigger service account object"
  type        = object({
    name  = string
    id = string
  })
